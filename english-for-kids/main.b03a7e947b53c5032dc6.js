/*! For license information please see main.b03a7e947b53c5032dc6.js.LICENSE.txt */
...
`,To=It.div`
  ...
  font-weight: bold;
  transition: 300ms;
`,Oo=({className:t,isGameMode:n,data:r,words:a})=>{const{category:o}=r,i=r.words?_a(a[0].image):_a(Sa);return e.createElement(So,{className:t},e.createElement(Co,{className:n?"game":"",path:o._id},e.createElement(_o,{src:i,alt:o.name}),e.createElement(No,null,e.createElement(To,null,o.name),e.createElement("div",null,"Words: ",r.words))))},Po=It.ul`
  display: flex;
  flex-wrap: wrap;
  justify-content: center;
  grid-gap: 20px;
